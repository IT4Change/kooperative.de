# Kooperative Dürnau - Website Sitemap

Analyse der Sitemap aus `docs/wwweb.pdf`.
...
Globale Suchfunktion (seitenübergreifend).

---

## Bestellung (Shop)

Einstiegsseite: **"Wie es geht"** - erklärt den Bestellprozess.
...
Arbeitsbereiche der Kooperative. Einige verlinken auf externe Websites (WWW).
...
| Druckerei | - |
| Schreinerei | - |
| Gärtnerei Morgengrauen | WWW |
| Allround Dienst Reisiger | WWW |
...
Veranstaltungen verlinken auf einen gemeinsamen **Kalender**.
