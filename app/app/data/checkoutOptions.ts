...
export const PAYMENT_OPTIONS: PaymentDisplay[] = [
  {
    id: 'vorkasse',
    label: 'Bezahlung mit Vorkasse',
    description: 'Überweisung im Voraus auf das angegebene Konto.',
  },
  {
    id: 'rechnung',
    label: 'Bezahlung mit Rechnung',
    description: 'Sie erhalten eine Rechnung mit der Lieferung.',
  },
  {
    id: 'lastschrift',
    label: 'Lastschriftverfahren IBAN (DE)',
    description: 'Wir buchen den Betrag von Ihrem Konto ab. Eingabe der IBAN erforderlich.',
  },
]
